...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#showSubareaWindow').window({
	        width: 800,
	        modal: true,   // modal  模式
	        shadow: true,  //shadow  影子
	        closed: true,  //closed  关闭的
	        height: 700,
	        resizable:false  //resizable  可变尺寸的
	    });
...
<%--用于展示图表的窗口--%>
	<div class="easyui-window" title="区域分区分布图" id="showSubareaWindow2" collapsible="false" minimizable="false" maximizable="false" style="top: 20px;left: 200px">
		<%--用于展示图表的div--%>
		<div id="test2" split="false" border="false"></div>
	</div>
