 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://web.itheima.cn/", wsdlLocation = "http://192.168.45.1:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://web.itheima.cn/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.45.1:8080/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://web.itheima.cn/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://web.itheima.cn/", "HelloServicePort"), HelloService.class, features);
    }
